            ...
            <div className={cx('container-fluid', 'footer')}>
                <div className={cx('container')}>
                    <div className={cx('row')}>
                        <div className={cx('footer-info-left', 'col-md-4')}>
                            <div className={cx('left-title')}>
                                <span className={cx('left-title-left')}>GH</span>
                                <span className={cx('left-title-right')}>TDUC</span>
                            </div>
                            <div className={cx('footer-slogan')}>
                                <span>Chăm sóc sức khỏe, dẫn đầu về chuyên môn y khoa và hơn thế nữa.</span>
                                <br></br>
                                <span>Hãy tin tưởng và cảm nhận.</span>

                            </div>
                        </div>
                        <div className={cx('footer-info-center', 'col-md-4')}>
                            ...
                            <div className={cx('to-flex', 'left-address')}>
                                ...
                                <p>Địa chỉ: Khu phố Tân Lập, Phường Đông Hòa, TP. Dĩ An, Tỉnh Bình Dương </p>
                            </div>
                            <div className={cx('to-flex', 'left-email')}>
                                ...
                                <p>Email: trung.phamquang@hcmut.edu.vn</p>
                            </div>
                        ...
                        <div className={cx('footer-info-right', 'col-md-2')}>
