...
export default function Mailcontent({listemail, num}) {
    console.log(num)
    console.log(listemail[2])
    return(
        <div className={cx('email-content')}>
            ...
            <div className={cx('content-wrapper')}>
                <div className={cx('content-header')}>
                    aa
                    {/* <div className={cx('content-header-name')}>{listemail[num].sender}</div> */}
                    {/* <div className={cx('content-header-time')}>{listemail[num].date}</div> */}
                </div>
