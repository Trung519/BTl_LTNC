                                                ...
                                                >
                                                    ...
                                                    <table className="collapse-table">
                                                        <thead>
                                                            ...
                                                            {formsState.includes(row.id) ? <th className="maintain-header"></th> : <>
                                                                <th className="maintain-header">Trạng thái</th>
                                                ...
                                                >
                                                    ...
                                                    <table className="collapse-table">
                                                        <thead>
                                                            ...
                                                            {formsUseState.includes(row.id) ? <th className="header-use"></th> : (
                                                                <>
